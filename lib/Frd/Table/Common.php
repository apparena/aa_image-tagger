...
class Frd_Table_Common  extends Zend_Db_Table
{
  ...
  function exists()
  {
    ...
    {
      $select->where($this->primary_key."=?",$key);
    }
  ...
  function save()
  {
    ...
    if($this->has_load == true)
    {
      ...
      $count=$this->update($this->data,$where);
      return $count;
    }
    else
    {
      if($this->created_at_field != false)
        $this->data[$this->created_at_field]=date("Y-m-d H:i:s");
      if($this->modified_at_field != false)
        $this->data[$this->modified_at_field]=date("Y-m-d H:i:s");
  ...
  function load($keys=array())
  {
    ...
    else
    {
      ...
      if (is_array($this->primary_key))
      {
        ...
        {
          $this->primary_value[]=$this->data[$key];
        }
      }
      else
      {
